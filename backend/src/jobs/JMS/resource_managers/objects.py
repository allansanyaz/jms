...
class DataSection:
    def __init__(self, SectionHeader, DataFields):
        """
        Inputs:
         SectionHeader: String that describes the resource,
                        rendered in the Cluster Management
                        settings table 
         DataFields: list containing objects of type DataField
        """
...
class DataField:
    def __init__(self, Key, Label, ValueType, DefaultValue, Disabled=False):
        """
        Inputs:
          Key: A string that is used to obtain the matching 
               value from qstat
          Label: The string to be displayed in the job details
          ValueType: Integer 1-4, that are used by knockout.js 
                     to track some state
          DefaultValue: Often overridden by the "n/a" string as
                        as a default
