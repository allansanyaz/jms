...
jobs_dir = Path(__file__).resolve().parent.parent.parent.parent
sys.path.append(jobs_dir.as_posix())
#from jobs.models import AccessRight, Condition, Status, ParameterType
